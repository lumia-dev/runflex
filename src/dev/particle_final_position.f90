module particle_final_position
    ...
    subroutine output_particles_final_position
        ...
        use com_mod,   only : numpart, path, compoint, numpoint
        ...
        do irl = 1, numpoint
            ...
            filter = particles%release == irl
            parts = pack(particles, particles%release == irl)
...
end module particle_final_position
